...
public class ReportPersistence {
	...
	private static class DbHelper extends SQLiteOpenHelper {
		...
		DATABASE_TABLE, COL_KEY, COL_PATH, COL_DATE, COL_COMPLETION_INDEX, COL_ELAPSED_DURATION, COL_ELAPSED_GAP, COL_ELAPSED_LENGTH, COL_ROUTE_DURATION, COL_ROUTE_GAP, COL_ROUTE_LENGTH);
